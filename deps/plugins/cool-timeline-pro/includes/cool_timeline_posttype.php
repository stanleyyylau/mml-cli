...
// END public function __construct())
        ...
        function add_new_cool_timeline_columns($gallery_columns) {
            ...
            $new_columns['year'] = __('Story Year', 'column name', 'cool-timeline');
            $new_columns['story_date'] = _x('Story Date', 'column name', 'cool-timeline');
            ...
            switch ($column) {
                ...
                case "images":
                    ...
                    if ($story_format == "video") {
                        echo'<div class="video"><img width="150" height="150" src="' . COOL_TIMELINE_PLUGIN_URL . '/images/youtube.png" alt="" /></div>';
                    } else if ($story_format == "slideshow") {
                        echo'<div class="slideshow"><img width="150" height="150" src="' . COOL_TIMELINE_PLUGIN_URL . '/images/slideshow.png" alt="" /></div>';
            ...
            if (($current_rules = get_option('rewrite_rules'))) {
                ...
                foreach ($current_rules as $key => $val) {
                    if (strpos($key, 'cool_timeline') !== false) {
                        add_rewrite_rule(str_ireplace('cool_timeline', 'timeline', $key), $val, 'top');
                    } // end if
                } // end foreach
            } // end if/else
