  ...
  class BF_Admin_Page_Class {
    ...
    public function DisplayPage() {
      ...
      echo '<form method="post" name="'.apply_filters('apc_form_name', 'admin_page_class',$this).'" class="'.apply_filters('apc_form_class', 'admin_page_class',$this).'" id="'.apply_filters('apc_form_id', 'admin_page_class',$this).'" action="" enctype="multipart/form-data">
        ...
        echo '<img class="timeline_logo" src="'.COOL_TIMELINE_PLUGIN_URL.'/images/cooltimeline-logo.jpg">'."\n".((isset($this->args['page_header_text']))? $this->args['page_header_text'] : '').' 
        </div><div class="support_links" > </div>'."\n".'
        <div class="ctl_save">'."".'
    ...
    <img src="' . COOL_TIMELINE_PLUGIN_URL . 'images/cooltimeline-logo.jpg"></a>
    </div>
    <hr>
    <div>
	<h2 class="ctl_add_head">Leave A Review</h2>
	<p>Please Give us Your support by providing <br> positive reviews.</p>
	<div><a target="_blank" href="https://codecanyon.net/item/cool-timeline-pro-wordpress-responsive-timeline-plugin/reviews/17046256"><img src="' . COOL_TIMELINE_PLUGIN_URL . '/images/stars5.png"></a>
	</div>

    <hr>
    <div>
    <a target="_blank" href="http://www.cooltimeline.com">
    <img src="' . COOL_TIMELINE_PLUGIN_URL . '/images/7-cool-timeline-demos.png"></a> <a target="_blank" href="http://www.cooltimeline.com/documentation"><img src="' . COOL_TIMELINE_PLUGIN_URL . '/images/view-docs.png"></a></div>
    </div>';
