			...
			'faq'                    => [
				'en' => [
					[
						...
						'title' => __('Pages Are Not Cached or CSS and JS Minification Are Not Working', 'rocket' ),
					],
					[
						...
						'title' => __('Google PageSpeed Grade does not Improve', 'rocket' ),
					],
					[
						...
						'title' => __('My Site Is Broken', 'rocket' ),
					],
					[
						...
						'title' => __('Resolving Issues with File Optimization', 'rocket' ),
					],
				],
				'fr' => [
					[
