...
<style>
#sub-page-banner{
        background: url("/wp-content/uploads/2018/05/P02-P04.jpg") no-repeat center;
    }
...
document.getElementsByTagName('body')[0].classList.add('with_aside');
document.getElementsByTagName('body')[0].classList.add('aside_left');
...
$(document).ready(function(){
	$('.right-cate span').eq(0).find('a').attr('href', '/accessory-products/')
	$('.right-cate span').eq(1).find('a').attr('href', '/accessory/')
})
</script>
<?php get_footer();
